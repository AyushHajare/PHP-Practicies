...
include('validation-script2.php');
?>
 ...
 <div class="row">
   ...
   <div class="col-sm-4">
    ...
    <div class="registration-form">
      <h4 class="text-center">Login with your Account</h4>
...
<?php if($passErr!=1){ echo $passErr; } ?>
        ...
        <button type="submit" class="btn btn-danger" value="Register" name="register">Login Now</button>
      </form>
    </div>
   </div>
   <div class="col-sm-4">
